...
class Localization : public rclcpp::Node
{
  public:
    ...
    : Node("local_node2")
    {
      ...
      cmd_vel_sub = this->create_subscription<geometry_msgs::msg::Twist>("/turtle_2/cmd_vel", 1, std::bind(&Localization::cmd_vel_cb, this, _1));
      local_sub = this->create_subscription<nav_msgs::msg::Odometry>("/turtle_2/dm_local", 1, std::bind(&Localization::local_cb, this, _1));
      lidar_sensor_sub = this->create_subscription<sensor_msgs::msg::LaserScan>("/turtle_2/scan", qos, std::bind(&Localization::lidar_sensor_cb, this, _1));
      dwm1000_sub = this->create_subscription<nav_msgs::msg::Odometry>("/turtle_2/dwm1000", qos, std::bind(&Localization::dwm1000_cb, this, _1));

      // map_sub = this->create_subscription<std_msgs::msg::Float32MultiArray>("/tortal_map", qos, std::bind(&Localization::map_cb, this, _1));
      local_pub = this->create_publisher<nav_msgs::msg::Odometry>("/turtle_2/real_local", 10);
      obstacle_pub = this->create_publisher<std_msgs::msg::Int32MultiArray>("/turtle_2/obstacles", 10);
  ...
  private:
    ...
    int turtle_real_x = 80;
    int turtle_real_y = 30;
    double turtle_real_heading = 1.5;

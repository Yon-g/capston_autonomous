...
class Map_Plot(Node):
    ...
    def __init__(self):
        ...
        self.dwm1000_local_sub1 = self.create_subscription(Odometry, '/turtle_1/dwm1000', self.dwm1000_cb1, 10)
        self.dwm1000_local_sub2 = self.create_subscription(Odometry, '/turtle_2/dwm1000', self.dwm1000_cb2, 10)
        self.dwm1000_local_sub3 = self.create_subscription(Odometry, '/turtle_3/dwm1000', self.dwm1000_cb3, 10)
        self.dwm1000_local_sub4 = self.create_subscription(Odometry, '/turtle_4/dwm1000', self.dwm1000_cb4, 10)
        ...
        self.turtle_mab_sub = self.create_subscription(Int32MultiArray, '/turtle_1/map', self.path_map_cb, 10)
        ...
        self.turtle1_dwm1000_x = None
        self.turtle1_dwm1000_y = None
        self.turtle2_dwm1000_x = None
        self.turtle2_dwm1000_y = None
        self.turtle3_dwm1000_x = None
        self.turtle3_dwm1000_y = None
        self.turtle4_dwm1000_x = None
        self.turtle4_dwm1000_y = None
    ...
    def real_local_cb1(self, msg):
        self.turtle1_x = msg.pose.pose.position.x
    ...
    def dwm1000_cb1(self, msg):
        self.turtle1_dwm1000_x = msg.pose.pose.position.x * 100 / 3
        self.turtle1_dwm1000_y = msg.pose.pose.position.y * 100 / 3

    def dwm1000_cb2(self, msg):
        self.turtle2_dwm1000_x = msg.pose.pose.position.x * 100 / 3
        self.turtle2_dwm1000_y = msg.pose.pose.position.y * 100 / 3

    def dwm1000_cb3(self, msg):
        self.turtle3_dwm1000_x = msg.pose.pose.position.x * 100 / 3
        self.turtle3_dwm1000_y = msg.pose.pose.position.y * 100 / 3

    def dwm1000_cb4(self, msg):
        self.turtle4_dwm1000_x = msg.pose.pose.position.x * 100 / 3
        self.turtle4_dwm1000_y = msg.pose.pose.position.y * 100 / 3
    ...
    def plot_map(self):
        ...
        if self.turtle_is_turtle_map_cb:
            plt.plot(self.turtle_map_x,self.turtle_map_y,"co")
        if MODE == 1:
        ...
        if self.turtle1_dwm1000_x is not None and self.turtle2_dwm1000_x is not None and self.turtle3_dwm1000_x is not None and self.turtle4_dwm1000_x is not None:
            plt.plot(self.turtle1_dwm1000_x,self.turtle1_dwm1000_y,'or')
            plt.plot(self.turtle2_dwm1000_x,self.turtle2_dwm1000_y,'ob')
            plt.plot(self.turtle3_dwm1000_x,self.turtle3_dwm1000_y,'ok')
            plt.plot(self.turtle4_dwm1000_x,self.turtle4_dwm1000_y,'og')

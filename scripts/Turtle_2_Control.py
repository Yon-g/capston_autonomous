...
class Control(Node):
    ...
    def __init__(self):
        ...
        self.local_sub = self.create_subscription(Odometry, '/turtle_2/real_local', self.real_local_cb, 10)
        self.path_sub = self.create_subscription(Int32MultiArray, '/turtle_2/path', self.path_cb, 10)
        self.goal_sub = self.create_subscription(Int32MultiArray, '/turtle_2/target_goal', self.target_goal_cb, 10)
        self.center_control_sub = self.create_subscription(Int32, '/turtle_2/center_control', self.center_control_cb, 10)
        self.contorl_pub = self.create_publisher(Twist, '/turtle_2/cmd_vel', 10)
        self.control_mode_pub = self.create_publisher(Int32, '/turtle_2/control_mode', 10)
